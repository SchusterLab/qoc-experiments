"""
piccolo_exp3.py - experiment 3 for the piccolo system.
"""
...
EXTENSION_STEP_COUNT = 100
RAND_PARAMS = ((anp.random.rand(EXTENSION_STEP_COUNT) - (1/2))
               + 1j * (anp.random.rand(EXTENSION_STEP_COUNT) - (1/2)))
PARAM_0_EXTENSION = MAX_AMP_T * 1e-2 * RAND_PARAMS
PARAM_1_EXTENSION = MAX_AMP_T * 1e-2 * RAND_PARAMS
PARAM_2_EXTENSION = MAX_AMP_C * 1e-2 * RAND_PARAMS
PARAM_EXTENSION = anp.swapaxes(anp.stack((PARAM_0_EXTENSION,
                                        PARAM_1_EXTENSION,
                                        PARAM_2_EXTENSION)), -1, -2)
INITIAL_PARAMS = anp.append(PICCOLO_EXP2_BEST_PARAMS, PARAM_EXTENSION, axis=0)
...
TARGET_STATE_0 = anp.kron(TRANSMON_G, CAVITY_THREE)

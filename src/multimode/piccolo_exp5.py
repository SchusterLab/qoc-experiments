"""
piccolo_exp5.py - experiment 5 for the piccolo system.
"""
...
PICCOLO_EXP4_BEST_TRIAL = 105
PICCOLO_EXP4_BEST_PARAMS = (h5py.File("/home/tcpropson/repos/summer19/"
                                      "experiments/pulses/piccolo_exp4/"
                                      "00000_piccolo_exp4.h5")
                            ["params"][PICCOLO_EXP4_BEST_TRIAL])
INITIAL_PARAMS = PICCOLO_EXP4_BEST_PARAMS
...
TARGET_STATE_0 = anp.kron(TRANSMON_G, (CAVITY_ZERO + CAVITY_FOUR) / anp.sqrt(2))

"""
piccolo_exp4.py - experiment 4 for the piccolo system.
"""
...
PICCOLO_EXP3_BEST_TRIAL = 326
PICCOLO_EXP3_BEST_PARAMS = (h5py.File("/home/tcpropson/repos/summer19/"
                                      "experiments/pulses/piccolo_exp3/"
                                      "00005_piccolo_exp3.h5")
                            ["params"][PICCOLO_EXP3_BEST_TRIAL])
INITIAL_PARAMS = PICCOLO_EXP3_BEST_PARAMS
...
TARGET_STATE_0 = anp.kron(TRANSMON_G, CAVITY_FOUR)

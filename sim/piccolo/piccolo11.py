"""
picollo11.py - piccolo experiment 11
"""
...
# Define paths
META_NAME = "piccolo"
EXPERIMENT_NAME = "piccolo11"
SAVE_PATH = os.path.join(os.environ["MULTIMODE_QOC_PATH"], "out", META_NAME, EXPERIMENT_NAME)
...
ALPHA = 2 * np.pi * -1.3951263895963648e-1
CHI_E = 2 * np.pi * -5.644535742521878e-4
